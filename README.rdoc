...
BVUserAgent is a Ruby library that parses and compares HTTP User Agents.
...
==== Reporting
  ...
  user_agent = BVUserAgent.parse(string)	
  user_agent.browser
  # => 'Chrome'
  user_agent.version
  # => '19.0.1084.56'
...
==== Comparison
  ...
  user_agent = BVUserAgent.parse(request.user_agent)
